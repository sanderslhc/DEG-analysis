...
sizeGrWindow(8, 6)
tiff(file = "E:/转录组分析-奶牛副结核/李厚诚-文章修改图/WGCNA/JJ.tiff", res = 600, width = 4800, height = 4800, compression = "lzw")
par(mfcol = c(2,2));
...
sizeGrWindow(8,6);
tiff(file = "E:/转录组分析-奶牛副结核/李厚诚-文章修改图/WGCNA/PB1.tiff", res = 600, width = 4800, height = 4800, compression = "lzw")
